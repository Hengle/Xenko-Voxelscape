...
namespace Voxelscape.Utility.Common.Core.Collections
{
	...
	public struct TupleStruct<T1, T2, T3, T4, T5, T6> : IEquatable<TupleStruct<T1, T2, T3, T4, T5, T6>>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="TupleStruct{T1,T2,T3,T4,T5,T6}"/> struct.
		/// </summary>
		...
		public static bool operator ==(
			TupleStruct<T1, T2, T3, T4, T5, T6> lhs, TupleStruct<T1, T2, T3, T4, T5, T6> rhs) => lhs.Equals(rhs);
		...
		#region IEquatable<TupleStruct<T1, T2, T3, T4, T5, T6>> Members
		...
		public override int GetHashCode() => HashCode.Start
			.And(this.Item1).And(this.Item2).And(this.Item3).And(this.Item4).And(this.Item5).And(this.Item6);
