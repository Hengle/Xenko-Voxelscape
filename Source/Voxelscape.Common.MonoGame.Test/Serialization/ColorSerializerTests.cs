...
namespace Voxelscape.Common.MonoGame.Test.Serialization
{
	...
	///
	/// </summary>
	public static class ColorSerializerTests
	{
		private static readonly int ExpectedLength = ByteLength.Byte * 3;
		...
		public static void RunTests(Color value) =>
			ConstantSerializerDeserializerTests.RunTests(RGBColorSerializer.Get, value, ExpectedLength);
	}
}
