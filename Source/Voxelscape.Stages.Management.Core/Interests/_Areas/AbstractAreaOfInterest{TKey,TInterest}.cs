...
namespace Voxelscape.Stages.Management.Core.Interests
{
		...
		where TKey : struct, IIndex
	{
		...
		/// </summary>
		private readonly IReadOnlySet<TKey> keys;
		...
		private IReadOnlySet<TKey> GetKeys(TKey origin) => new OffsetSet(this, origin);

		private class OffsetSet : IReadOnlySet<TKey>
		{
